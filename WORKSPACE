...
# General proto support (for dependencies only)
...
go_repository(
    ...
    sum = "h1:HKKXKZmOaf1UtYn+/ga7+QSLvK7l6K5Mppj9yGgXYCo=",
    version = "v1.41.0-dev.0.20210907181116-2f3355d2244e",
)
...
go_repository(
    ...
    sum = "h1:QWMn1lFvU/nZ58ssWqiFJMd3DKIII8NYc4sn708XgKs=",
    version = "v0.0.0-20211007125505-59d4e928ea9d",
)
